...
import com.squareup.easyshop.utils.NetworkUtil;
...
public class EasyShopServiceManager {
    //域名
    ...
    //单例模式
    private static EasyShopServiceManager instance;
    private Retrofit retrofit;
    private EasyShopServiceManager(){
        //设置缓存目录
    ...
    //单例，懒汉式线程安全
    public static synchronized EasyShopServiceManager getInstance(){
        if(instance==null)
            instance=new EasyShopServiceManager();
        return instance;
    }
