...
public class CornersConstraintLayout extends ConstraintLayout {
    ...
    public CornersConstraintLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CornersConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
